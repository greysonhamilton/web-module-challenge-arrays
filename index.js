...
let not31Flavors = [...originalFlavors];
not31Flavors.pop();
console.log(not31Flavors);

function no31Flavors(){
    not31Flavors.length; {
        if (no31Flavors===31) {
            return "True";
        } else {
...
function removeFlavorByName(Vanilla){
    originalFlavors.includes("Vanilla",0);{
...
let oldFlavors = [...originalFlavors];
...
function filterByWord(originalFlavors, Chocolate){
    for (let i = originalFlavors.length; i > 0; i--){
        if(originalFlavors.includes(Chocolate,i)){
            filteredArray++;
        }
    }
